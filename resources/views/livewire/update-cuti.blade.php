<div wire:ignore.self class="modal fade" id="updateCutiModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form>
            ...
            <div class="modal-footer">
                ...
                <button wire:click.prevent="updateCuti()" type="button" class="btn btn-primary">Save changes</button>
            </div>
        </form>
      </div>
    </div>
